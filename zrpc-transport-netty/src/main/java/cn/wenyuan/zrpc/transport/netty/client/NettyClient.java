...
import cn.wenyuan.zrpc.transport.netty.client.context.ContextAwareCompletableFuture;
import cn.wenyuan.zrpc.common.context.RpcContext;
import cn.wenyuan.zrpc.common.message.RpcRequest;
import cn.wenyuan.zrpc.common.message.RpcResponse;
import cn.wenyuan.zrpc.transport.netty.client.timeout.RpcTimeoutManager;
...
public class NettyClient implements RpcClient {
    ...
    public void awaitFirstConnection(long timeout, TimeUnit unit) {
        try {
